          ...
          {historico.map((item, idx) => (
            <li key={idx} className="historico-item">
              ...
              <button
                ...
                style={{ marginLeft: 12, padding: '4px 14px', borderRadius: 6, background: 'var(--red)', color: 'var(--black)', border: 'none', fontWeight: 'bold', cursor: 'pointer', fontSize: 14 }}
                onClick={() => {
                  setEmailModal({
                    open: true,
                    idx
              ...
              <button
                ...
                style={{ marginLeft: 6, padding: '4px 10px', borderRadius: 6, background: 'var(--gray, #eee)', color: 'var(--black)', border: 'none', fontWeight: 'bold', cursor: 'pointer', fontSize: 14 }}
          ...
          <div className="modal-resultado modal-resultado-animado" style={{maxWidth: 400}}>
            ...
            {emailStatus.success && (
              <div style={{marginTop: 24, textAlign: 'center'}}>
                <p style={{color: 'green', fontWeight: 'bold'}}>E-mail enviado com sucesso!</p>
